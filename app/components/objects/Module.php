...
abstract class Module extends \infinite\base\Module {
	...
	function __construct($id, $parent, $config=null) {
		...
		$migrationDirectory = $this->basePath . DIRECTORY_SEPARATOR . 'migrations';
		if (is_dir($migrationDirectory)) {
			$paths = Yii::$app->params['migrationPaths'];
			$paths[] = ''. $this->name .'.migrations';
			Yii::$app->params['migrationPaths'] = $paths;
		}
